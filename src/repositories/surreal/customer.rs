//! SurrealDB customer repository adapter.
...
use crate::{
    ...
    models::customer::{Address, Customer, NewCustomer},
    repositories::{
        customer::{ArchiveFilter, CustomerFilter, CustomerRepository, RepositoryPage},
        RepositoryError,
    },
};
