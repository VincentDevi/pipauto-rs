//! Technical-note validation, source consistency, search, and archive workflows.
...
use crate::{
    ...
    models::technical_note::{NewTechnicalNote, TechnicalNote, TechnicalNoteModelError},
    repositories::{
...
#[derive(Clone)]
pub struct TechnicalNoteService {
