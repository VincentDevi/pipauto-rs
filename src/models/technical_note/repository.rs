//! Private technical-note persistence contract.
...
use crate::{
    models::customer::repository::{ArchiveFilter, RepositoryPage},
    models::persistence_error::PersistenceError as RepositoryError,
};
