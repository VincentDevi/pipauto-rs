//! Invoice model operations for drafting, issuing, and append-only payments.
...
use crate::{
    ...
    models::{
        auth::UserId,
        customer::{repository::CustomerRepository, Customer},
        intervention::{repository::InterventionRepository, InterventionStatus},
        invoice::{
