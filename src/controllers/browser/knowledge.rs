...
use crate::{
    ...
    domain::{
        normalize_search_text, InterventionId, OpaqueCursor, Page, PageLimit, PageRequest,
        TechnicalNoteId, ValidationCode, ValidationError, ValidationErrors, VehicleId,
    },
    models::{
...
async fn show(
    ...
    let view = KnowledgeDetailPage::new(layout(&context), note, vehicle, source);
    Ok(responses::render(
        context.response_preference,
        StatusCode::OK,
        view.render_page(&engine)?,
